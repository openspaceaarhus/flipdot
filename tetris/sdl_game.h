 ...
 * Image files
 */
#define STC_BMP_TILE_BLOCKS     "images/blocks.bmp"
#define STC_BMP_BACKGROUND      "images/back.png"
#define STC_BMP_NUMBERS         "images/numbers.bmp"
